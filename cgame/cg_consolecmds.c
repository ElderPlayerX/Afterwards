...
==================
*/
static void CG_SelectMenu_f (void ) {
	if ( cgs.gametype == GT_TACTICAL && cg_awMenu.integer == 0 ) { // can't open any menu twice
		CG_AwInitMenu( SM_WEAPONS_MAIN );
	}
}
...
==================
*/
static void CG_TeamSelectMenu_f (void ) {
	if ( cgs.gametype == GT_TACTICAL && cg_awMenu.integer == 0 ) { // can't open any menu twice
		CG_AwInitMenu( SM_TEAM_SELECT );
	}
}
...
==================
*/
static void CG_MapInfo_f (void ) {
	if ( cgs.gametype == GT_TACTICAL && cg_awMenu.integer == 0 ) { // can't open any menu twice
		CG_AwInitMenu( SM_MAPINFO );
	}
}
...
==================
*/
static void CG_MenuItem_f (void ) {
	int num;

	num = atoi( CG_Argv( 1 ) );
	
	if ( cgs.gametype != GT_TACTICAL || cg_awMenu.integer == 0 ) { // buy menu not open, change weapon
		CG_WeaponChange ( num );
	} else { // Afterwards menu open, select menu item
		CG_AwMenuSelect( num );
	}
}
...
static consoleCommand_t	commands[] = {
	...
	{ "weapon", CG_MenuItem_f },
	{ "tell_target", CG_TellTarget_f },
	{ "tell_attacker", CG_TellAttacker_f },
	{ "vtell_target", CG_VoiceTellTarget_f },
	{ "vtell_attacker", CG_VoiceTellAttacker_f },
	{ "tcmd", CG_TargetCommand_f },
	{ "selectmenu", CG_SelectMenu_f },
	{ "teamselect", CG_TeamSelectMenu_f },
	{ "mapinfo", CG_MapInfo_f },
#ifdef MISSIONPACK
