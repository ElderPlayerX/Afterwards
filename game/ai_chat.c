...
char *BotWeaponNameForMeansOfDeath(int mod) {
	switch(mod) {
		case MOD_STANDARD: return "Standard Pistol";
		case MOD_HANDGUN: return "Elite Handgun";
		case MOD_MICRO: return "Micro Erazor";
		case MOD_SHOTGUN: return "Shotgun";
		case MOD_SUB: return "Submachine Gun";
		case MOD_A_RIFLE: return "Assault Rifle";
		case MOD_SNIPER: return "Sniper Rifle";
		case MOD_MINIGUN: return "Minigun";
		case MOD_GRENADE:
		case MOD_GRENADE_SPLASH: return "Grenade Launcher";
		case MOD_ROCKET:
		case MOD_ROCKET_SPLASH: return "Rocket Launcher";
		case MOD_DBT: 
		case MOD_DBT_SPLASH: return "BFG";
		case MOD_SHOCKER: return "Shocker";
		case MOD_FLAMETHROWER: return "Flamethrower";
		case MOD_TRIPACT: return "Tripact";
...
int BotValidChatPosition(bot_state_t *bs) {
	...
	if (bs->inventory[INV_ITEM]) return qfalse;
