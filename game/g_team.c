...
qboolean OnSameTeam( gentity_t *ent1, gentity_t *ent2 ) {
	...
	if ( team1 > TEAM_SPECTATOR ) team1 -= 3;
	team2 = ent2->client->sess.sessionTeam;
	if ( team2 > TEAM_SPECTATOR ) team2 -= 3;
...
gentity_t *SelectRandomTeamSpawnPoint( int teamstate, team_t team ) {
	...
	if (team == TEAM_RED)
		classname = "info_player_tribes";
	else if (team == TEAM_BLUE)
		classname = "info_player_australians";
	else
		return NULL;
...
Format:
	clientNum location health weapon
...
//				level.sortedClients[i], player->client->pers.teamState.location, h, a, 
				...
				player->client->ps.weapons[player->client->ps.wpcat] );
			j = strlen(entry);
...
/*QUAKED info_player_tribes (1 0 0) (-16 -16 -24) (16 16 32)
Only in tactical games. Tribes spawn here.
*/
void SP_info_player_tribes( gentity_t *ent ) {
}


/*QUAKED info_player_australians (0 0 1) (-16 -16 -24) (16 16 32)
Only in tactical games. Australians spawn here.
*/
