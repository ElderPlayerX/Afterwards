...
static void UI_AddBotsMenu_BotEvent( void* ptr, int event ) {
	...
	addBotsMenuInfo.bots[addBotsMenuInfo.selectedBotNum].color = cg_color;
...
static void UI_AddBotsMenu_Init( void ) {
	...
	for( n = 0, y = 110; n < count; n++, y += 20 ) {
		...
		addBotsMenuInfo.bots[n].color				= cg_color;
	...
	addBotsMenuInfo.go.generic.y			= 256+128-84;
	...
	addBotsMenuInfo.back.generic.y			= 256+128-84;
