...
#define ID_DROPITEM		33
#define ID_CHAT			34
#define ID_CHAT2		35
#define ID_CHAT3		36
#define ID_CHAT4		37
#define ID_SELECT		38
#define ID_TEAMSELECT	39
#define ID_MAPINFO		40
#define ID_VOTEYES		41
#define ID_VOTENO		42
...
//	menuaction_s		useitem;
	...
	menuaction_s		chat4;
	menuaction_s		select;
	menuaction_s		teamselect;
	menuaction_s		mapinfo;
...
static bind_t g_bindings[] = 
{
	...
	{"+button2", 		"zoom view",		ID_ZOOMVIEW,	ANIM_IDLE,		-1,				-1,		-1, -1},
	{"weapon 1",		"select 1",			ID_WEAPON1,		ANIM_IDLE,		'1',			-1,		-1, -1},
	{"weapon 2",		"select 2",			ID_WEAPON2,		ANIM_IDLE,		'2',			-1,		-1, -1},
	{"weapon 3",		"select 3",			ID_WEAPON3,		ANIM_IDLE,		'3',			-1,		-1, -1},
	{"weapon 4",		"select 4",			ID_WEAPON4,		ANIM_IDLE,		'4',			-1,		-1, -1},
	{"weapon 5",		"select 5",			ID_WEAPON5,		ANIM_IDLE,		'5',			-1,		-1, -1},
	{"weapon 6",		"select 6",			ID_WEAPON6,		ANIM_IDLE,		'6',			-1,		-1, -1},
	{"weapon 7",		"select 7",			ID_WEAPON7,		ANIM_IDLE,		'7',			-1,		-1, -1},
	{"weapon 8",		"select 8",			ID_WEAPON8,		ANIM_IDLE,		'8',			-1,		-1, -1},
	{"weapon 9",		"select 9",			ID_WEAPON9,		ANIM_IDLE,		'9',			-1,		-1, -1},
	{"weapon 10",		"select 0",			ID_WEAPON0,		ANIM_IDLE,		'0',			-1,		-1, -1},
	{"+button5",		"reload weapon",	ID_RELOAD,		ANIM_IDLE,		K_INS,			-1,		-1, -1},
	{"+button6",		"drop weapon",		ID_DROP,		ANIM_IDLE,		'd',			-1,		-1, -1},
	{"+attack", 		"attack",			ID_ATTACK,		ANIM_ATTACK,	K_CTRL,			-1,		-1, -1},
	{"weapprev",		"prev weapon",		ID_WEAPPREV,	ANIM_IDLE,		'[',			-1,		-1, -1},
	{"weapnext", 		"next weapon",		ID_WEAPNEXT,	ANIM_IDLE,		']',			-1,		-1, -1},
	{"+button3", 		"gesture",			ID_GESTURE,		ANIM_GESTURE,	K_MOUSE3,		-1,		-1, -1},
	{"+button7",		"drop item",		ID_DROPITEM,	ANIM_IDLE,		'f',			-1,		-1, -1},
	{"messagemode", 	"chat",				ID_CHAT,		ANIM_CHAT,		't',			-1,		-1, -1},
	{"messagemode2", 	"chat - team",		ID_CHAT2,		ANIM_CHAT,		-1,				-1,		-1, -1},
	{"messagemode3", 	"chat - target",	ID_CHAT3,		ANIM_CHAT,		-1,				-1,		-1, -1},
	{"messagemode4", 	"chat - attacker",	ID_CHAT4,		ANIM_CHAT,		-1,				-1,		-1, -1},
	{"selectmenu",		"weapon selection",	ID_SELECT,		ANIM_IDLE,		'w',			-1,		-1, -1},
	{"teamselect",		"team selection",	ID_TEAMSELECT,	ANIM_IDLE,		'm',			-1,		-1, -1},
	{"mapinfo",			"display mapinfo",	ID_MAPINFO,		ANIM_IDLE,		'i',			-1,		-1, -1},
	{"vote y",			"vote 'yes'",		ID_VOTEYES,		ANIM_IDLE,		'y',			-1,		-1, -1},
	{"vote n",			"vote 'no'",		ID_VOTENO,		ANIM_IDLE,		'n',			-1,		-1, -1},
...
static menucommon_s *g_weapons_controls[] = {
	...
	(menucommon_s *)&s_controls.menui1,         
	(menucommon_s *)&s_controls.menui2,
	(menucommon_s *)&s_controls.menui3,          
	(menucommon_s *)&s_controls.menui4,
	(menucommon_s *)&s_controls.menui5,   
	(menucommon_s *)&s_controls.menui6,   
	(menucommon_s *)&s_controls.menui7,          
	(menucommon_s *)&s_controls.menui8,           
	(menucommon_s *)&s_controls.menui9,           
	(menucommon_s *)&s_controls.menui0,           
	NULL,
};
...
//	(menucommon_s *)&s_controls.useitem,
	...
	(menucommon_s *)&s_controls.select,
	(menucommon_s *)&s_controls.teamselect,
	(menucommon_s *)&s_controls.mapinfo,
...
static void Controls_ResetDefaults_Draw( void ) {
	UI_DrawProportionalString( SCREEN_WIDTH/2, 420 + PROP_HEIGHT * 0, "WARNING: This will reset all", UI_CENTER|UI_SMALLFONT|UI_CURSORSHADOW, color_yellow );
	UI_DrawProportionalString( SCREEN_WIDTH/2, 420 + PROP_HEIGHT * 1, "controls to their default values.", UI_CENTER|UI_SMALLFONT|UI_CURSORSHADOW, color_yellow );
}
...
static void Controls_MenuInit( void )
{
	...
	s_controls.menu.showlogo = LOGO_AFTERWARDS;
	...
	s_controls.looking.style			= UI_RIGHT|UI_CURSORSHADOW;
	...
	s_controls.movement.style			= UI_RIGHT|UI_CURSORSHADOW;
	...
	s_controls.weapons.style			= UI_RIGHT|UI_CURSORSHADOW;
	...
	s_controls.misc.style			= UI_RIGHT|UI_CURSORSHADOW;
	...
	s_controls.menui1.generic.type	  = MTYPE_ACTION;
	s_controls.menui1.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.menui1.generic.callback  = Controls_ActionEvent;
	s_controls.menui1.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.menui1.generic.id        = ID_WEAPON1;

	s_controls.menui2.generic.type	    = MTYPE_ACTION;
	s_controls.menui2.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.menui2.generic.callback  = Controls_ActionEvent;
	s_controls.menui2.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.menui2.generic.id        = ID_WEAPON2;

	s_controls.menui3.generic.type	     = MTYPE_ACTION;
	s_controls.menui3.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.menui3.generic.callback  = Controls_ActionEvent;
	s_controls.menui3.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.menui3.generic.id        = ID_WEAPON3;

	s_controls.menui4.generic.type	     = MTYPE_ACTION;
	s_controls.menui4.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.menui4.generic.callback  = Controls_ActionEvent;
	s_controls.menui4.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.menui4.generic.id        = ID_WEAPON4;

	s_controls.menui5.generic.type	    = MTYPE_ACTION;
	s_controls.menui5.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.menui5.generic.callback  = Controls_ActionEvent;
	s_controls.menui5.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.menui5.generic.id        = ID_WEAPON5;

	s_controls.menui6.generic.type	   = MTYPE_ACTION;
	s_controls.menui6.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.menui6.generic.callback  = Controls_ActionEvent;
	s_controls.menui6.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.menui6.generic.id        = ID_WEAPON6;

	s_controls.menui7.generic.type	     = MTYPE_ACTION;
	s_controls.menui7.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.menui7.generic.callback  = Controls_ActionEvent;
	s_controls.menui7.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.menui7.generic.id        = ID_WEAPON7;

	s_controls.menui8.generic.type	    = MTYPE_ACTION;
	s_controls.menui8.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.menui8.generic.callback  = Controls_ActionEvent;
	s_controls.menui8.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.menui8.generic.id        = ID_WEAPON8;

	s_controls.menui9.generic.type	     = MTYPE_ACTION;
	s_controls.menui9.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.menui9.generic.callback  = Controls_ActionEvent;
	s_controls.menui9.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.menui9.generic.id        = ID_WEAPON9;

	s_controls.menui0.generic.type	     = MTYPE_ACTION;
	s_controls.menui0.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.menui0.generic.callback  = Controls_ActionEvent;
	s_controls.menui0.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.menui0.generic.id        = ID_WEAPON0;
...
/*	s_controls.useitem.generic.type	     = MTYPE_ACTION;
	...
	s_controls.autoswitch.itemnames			= autoswitch_names;;
	...
	s_controls.select.generic.type	    = MTYPE_ACTION;
	s_controls.select.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.select.generic.callback  = Controls_ActionEvent;
	s_controls.select.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.select.generic.id        = ID_SELECT;

	s_controls.teamselect.generic.type	    = MTYPE_ACTION;
	s_controls.teamselect.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.teamselect.generic.callback  = Controls_ActionEvent;
	s_controls.teamselect.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.teamselect.generic.id        = ID_TEAMSELECT;

	s_controls.mapinfo.generic.type	     = MTYPE_ACTION;
	s_controls.mapinfo.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.mapinfo.generic.callback  = Controls_ActionEvent;
	s_controls.mapinfo.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.mapinfo.generic.id        = ID_MAPINFO;
	...
	Menu_AddItem( &s_controls.menu, &s_controls.menui1 );
	Menu_AddItem( &s_controls.menu, &s_controls.menui2 );
	Menu_AddItem( &s_controls.menu, &s_controls.menui3 );
	Menu_AddItem( &s_controls.menu, &s_controls.menui4 );
	Menu_AddItem( &s_controls.menu, &s_controls.menui5 );
	Menu_AddItem( &s_controls.menu, &s_controls.menui6 );
	Menu_AddItem( &s_controls.menu, &s_controls.menui7 );
	Menu_AddItem( &s_controls.menu, &s_controls.menui8 );
	Menu_AddItem( &s_controls.menu, &s_controls.menui9 );
	Menu_AddItem( &s_controls.menu, &s_controls.menui0 );
...
//	Menu_AddItem( &s_controls.menu, &s_controls.useitem );
	...
	Menu_AddItem( &s_controls.menu, &s_controls.select );
	Menu_AddItem( &s_controls.menu, &s_controls.teamselect );
	Menu_AddItem( &s_controls.menu, &s_controls.mapinfo );
