...
static void UI_DisplayOptionsMenu_Init( void ) {
	...
	displayOptionsInfo.menu.showlogo = LOGO_AFTERWARDS;
	...
	displayOptionsInfo.graphics.style				= UI_RIGHT|UI_CURSORSHADOW;
	...
	displayOptionsInfo.display.style				= UI_RIGHT|UI_CURSORSHADOW;
	...
	displayOptionsInfo.sound.style					= UI_RIGHT|UI_CURSORSHADOW;
	...
	displayOptionsInfo.network.style				= UI_RIGHT|UI_CURSORSHADOW;
