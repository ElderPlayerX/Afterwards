...
extern vmCvar_t	ui_tc_winlimit;
extern vmCvar_t	ui_tc_timelimit;
extern vmCvar_t	ui_tc_friendly;
...
extern vmCvar_t	ui_browserShowAwOnly;
...
#define QMF_CURSORSHADOW		0x00200000
...
// ui_serverinfo.c
//
extern void UI_ServerInfoMenu( const char *serverAddress );
...
typedef struct {
	...
	qhandle_t			menuBackStd1;
	qhandle_t			menuBackStd2;
	qhandle_t			menuBackFog;
	qhandle_t			menuBackLandscape;
...
extern void			UI_DeleteColorCodes( char* str );
