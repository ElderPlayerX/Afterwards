...
static void UI_NetworkOptionsMenu_Init( void ) {
	...
	networkOptionsInfo.menu.showlogo = LOGO_AFTERWARDS;
	...
	networkOptionsInfo.graphics.style				= UI_RIGHT|UI_CURSORSHADOW;
	...
	networkOptionsInfo.display.style				= UI_RIGHT|UI_CURSORSHADOW;
	...
	networkOptionsInfo.sound.style					= UI_RIGHT|UI_CURSORSHADOW;
	...
	networkOptionsInfo.network.style				= UI_RIGHT|UI_CURSORSHADOW;
