...
void Options_MenuInit( void ) {
	...
	s_options.banner.style			= UI_CURSORSHADOW | UI_CENTER;
	...
	s_options.graphics.style			= UI_CURSORSHADOW | UI_CENTER;
	...
	s_options.display.style				= UI_CURSORSHADOW | UI_CENTER;
	...
	s_options.sound.style				= UI_CURSORSHADOW | UI_CENTER;
	...
	s_options.network.style				= UI_CURSORSHADOW | UI_CENTER;
