...
static void UI_RemoveBotsMenu_BotEvent( void* ptr, int event ) {
	...
	removeBotsMenuInfo.bots[removeBotsMenuInfo.selectedBotNum].color = cg_color;
...
static void UI_RemoveBotsMenu_Init( void ) {
	...
	for( n = 0, y = 120; n < count; n++, y += 20 ) {
		...
		removeBotsMenuInfo.bots[n].color			= cg_color;
	...
	removeBotsMenuInfo.delete.generic.y			= 256+128-84;
	...
	removeBotsMenuInfo.back.generic.y			= 256+128-84;
