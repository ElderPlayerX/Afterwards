...
static void UI_SoundOptionsMenu_Init( void ) {
	...
	soundOptionsInfo.menu.showlogo = LOGO_AFTERWARDS;
	...
	soundOptionsInfo.graphics.style				= UI_RIGHT|UI_CURSORSHADOW;
	...
	soundOptionsInfo.display.style				= UI_RIGHT|UI_CURSORSHADOW;
	...
	soundOptionsInfo.sound.style				= UI_RIGHT|UI_CURSORSHADOW;
	...
	soundOptionsInfo.network.style				= UI_RIGHT|UI_CURSORSHADOW;
