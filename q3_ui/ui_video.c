...
static void UI_DriverInfo_Menu( void )
{
	...
	s_driverinfo.menu.showlogo   = LOGO_AFTERWARDS;
...
void GraphicsOptions_MenuInit( void )
{
	...
	s_graphicsoptions.graphics.style			= UI_RIGHT|UI_CURSORSHADOW;
	...
	s_graphicsoptions.display.style				= UI_RIGHT|UI_CURSORSHADOW;
	...
	s_graphicsoptions.sound.style				= UI_RIGHT|UI_CURSORSHADOW;
	...
	s_graphicsoptions.network.style				= UI_RIGHT|UI_CURSORSHADOW;
	...
	s_graphicsoptions.driverinfo.style            = UI_CENTER|UI_SMALLFONT|UI_CURSORSHADOW;
